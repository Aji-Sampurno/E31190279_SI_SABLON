    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        String u_nama = null;
            ...
            try {
                ...
                if(rs.getRow()>=1){
                    login1.setU_nama(u_nama);
                    KARYAWAN l=new KARYAWAN();
                    l.setVisible(true);
                    dispose();
                }else if(rs.getRow()==0){
                    JOptionPane.showMessageDialog(null,"Username, password tidak sesuai","Kantin Asrama", JOptionPane.WARNING_MESSAGE);
